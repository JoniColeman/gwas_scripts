...
def main():
    if len(sys.argv) >= 2:
        with open(sys.argv[1]) as bim_6_file:
            ...
            print 'Test:', Test
            print 'Match:', hg_18_score, 'out of', hg_18_length
            print '\nhg19 reference:', hg_19_ref
            print 'Test:', Test
            print 'Match:', hg_19_score, 'out of', hg_19_length
            print '\nhg38 reference:', hg_38_ref
            print 'Test:', Test
            print 'Match:', hg_38_score, 'out of', hg_38_length
    else:
